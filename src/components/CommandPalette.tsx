...
export default function CommandPalette() {
    ...
    return (
        ...
        >
            <div
                className="w-full max-w-lg bg-white dark:bg-gray-900 rounded-xl shadow-2xl border-2 border-black dark:border-gray-700 overflow-hidden animate-in fade-in zoom-in duration-200"
